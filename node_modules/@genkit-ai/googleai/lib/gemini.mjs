  ...
  return defineModel(
    ...
    (request, streamingCallback) => __async(this, null, function* () {
      ...
      const generationConfig = {
        ...
        temperature: (_b2 = request.config) == null ? void 0 : _b2.temperature,
        maxOutputTokens: (_c = request.config) == null ? void 0 : _c.maxOutputTokens,
        topK: (_d = request.config) == null ? void 0 : _d.topK,
        topP: (_e = request.config) == null ? void 0 : _e.topP,
        stopSequences: (_f = request.config) == null ? void 0 : _f.stopSequences,
        responseMimeType: ((_g = request.output) == null ? void 0 : _g.format) === "json" || ((_h = request.output) == null ? void 0 : _h.schema) ? "application/json" : void 0
      };
      const chatRequest = {
        systemInstruction,
        generationConfig,
        tools: ((_i = request.tools) == null ? void 0 : _i.length) ? [{ functionDeclarations: (_j = request.tools) == null ? void 0 : _j.map(toGeminiTool) }] : [],
      ...
      const jsonMode = ((_l = request.output) == null ? void 0 : _l.format) === "json" || !!((_m = request.output) == null ? void 0 : _m.schema);
      ...
      if (streamingCallback) {
        ...
        return {
          candidates: ((_p = response.candidates) == null ? void 0 : _p.map(fromJSONModeScopedGeminiCandidate)) || [],
          custom: response
        };
      } else {
        const result = yield client.startChat(chatRequest).sendMessage(msg.parts);
        if (!((_q = result.response.candidates) == null ? void 0 : _q.length))
          throw new Error("No valid candidates returned.");
        const responseCandidates = ((_r = result.response.candidates) == null ? void 0 : _r.map(fromJSONModeScopedGeminiCandidate)) || [];
        return {
